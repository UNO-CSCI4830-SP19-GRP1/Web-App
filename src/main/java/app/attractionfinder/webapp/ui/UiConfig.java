...
public class UiConfig {
	@Bean
	public UiHandler uiHandler(final TagRepository tagRepository, final AttractionRepository attractionRepository, final AttractionTagRepository attractionTagRepository) {
